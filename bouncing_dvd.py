...
Note: Press Ctrl-C to stop, do not resize the terminal window while this program is running.
"""
...
try:
    ...
    print("can install by following the instrutions at")
    ...
    while True:  # Main program loop.
        for logo in logos:  # Handle each logo in the logos list.
            ...
            if logo[DIR] != original_direction:
                # Changes color when the logo bounces:
            ...
            for logo in logos:
                # Draw the logos at their new locations:
                bext.goto(logo[X], logo[Y])
                bext.fg(logo[COLOR])
                print("DVD", end="")
